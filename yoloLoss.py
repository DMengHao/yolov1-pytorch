...
class yoloLoss(nn.Module):
    ...
    def forward(self, pred_tensor, target_tensor):
        ...
        box_target_response_iou = box_target_iou[coo_response_mask].view(-1, 5).to(box_pred_response.device)
        ...
        no_contain_loss = F.mse_loss(no_box_pred_response[:, 4], no_box_target_response_iou[:, 4].to(no_box_pred_response.device), size_average=False)
        # bbox坐标损失
